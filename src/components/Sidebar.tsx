...
export function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="sidebar-component-overlay" onClick={onClose}>
      <div className="sidebar-component" onClick={(e) => e.stopPropagation()}>
        {/* 헤더 */}
        <div className="sidebar-component-header">
          <div className="sidebar-header-content">
            <div className="sidebar-logo">UTIS</div>
            <div className="sidebar-search-bar">
              <svg className="sidebar-search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <circle cx="11" cy="11" r="8"/>
                <path d="m21 21-4.35-4.35"/>
              </svg>
              <span className="sidebar-search-text">어디로 가세요?</span>
            </div>
        ...
        <div className="sidebar-action-buttons">
          <button className="sidebar-search-button">예약 검색</button>
          <button className="sidebar-login-button" onClick={() => navigate('/login')}>로그인/회원가입</button>
        </div>
        ...
        <div className="sidebar-menu-sections">
          ...
          <div className="sidebar-menu-section">
            <h4 className="sidebar-section-title">여행 상품/서비스 메뉴</h4>
            <div className="sidebar-menu-items">
              <div className="sidebar-menu-item">
                <span>티켓</span>
                <svg className="sidebar-menu-icon" viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="sidebar-menu-item">
                <span>여행용품</span>
                <svg className="sidebar-menu-icon" viewBox="0 0 122.88 99.83" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* 기타 */}
          <div className="sidebar-menu-section">
            <h4 className="sidebar-section-title">기타</h4>
            <div className="sidebar-menu-items">
              <div className="sidebar-menu-item">
                <span>고객센터</span>
                <svg className="sidebar-menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
